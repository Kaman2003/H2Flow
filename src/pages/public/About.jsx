          ...
          <div className="ss-about-tab-content ss-about-mission">
            ...
            <div className="ss-about-mission-goals">
              <div className="ss-about-mission-goal">
                ...
                <p>
                  Ensuring access to water in homes and offices
                  worldwide.
                </p>
              </div>
              <div className="ss-about-mission-goal">
          ...
          <div className="ss-about-tab-content ss-about-story">
            ...
            <div className="ss-about-timeline">
              <div className="ss-about-timeline-item">
                <div className="ss-about-timeline-date">2025</div>
                <h4>The Idea is Born</h4>
                <p>
                  Our team, concerned about global water quality, envisioned
              ...
              <div className="ss-about-timeline-item">
                ...
                <p>
                  The first H2Flow prototype was unveiled, garnering
              ...
              <div className="ss-about-timeline-item">
                ...
                <p>
                  H2Flow will began rolling out to households and offices across
              ...
              <div className="ss-about-timeline-item">
                <div className="ss-about-timeline-date">2026</div>
                <h4>H2Flow </h4>
                <p>
                  We are trying to launched our updated device with enhanced AI
  ...
  return (
    <div className="ss-about-page">
      <header className="ss-about-header">
        <h1 className="ss-about-title">About H2Flow</h1>
